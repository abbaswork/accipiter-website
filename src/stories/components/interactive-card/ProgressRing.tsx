...
export const ProgressRing = ({ progress = 1, seoText, activeIndex }: ProgressRingProps) => {
...
if (activeIndex == 0) {
  ...
  return (
    <div className={styles['progress-ring-container']}>
      <svg width={SIZE} height={SIZE} style={{backgroundColor: 'white', borderRadius: '50%',  boxShadow: "0 0 4px 1px #c44a0a"}}>
        <defs>
        ...
        <defs>
          <filter id="glow" x="-40%" y="-40%" width="180%" height="180%">
            <feDropShadow dx="0" dy="0" stdDeviation="6" floodColor="#c44a0a" floodOpacity="0.7" />
          </filter>
        </defs>
        <text
          x="50%"
